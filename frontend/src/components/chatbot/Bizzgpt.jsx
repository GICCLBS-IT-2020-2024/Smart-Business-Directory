...
const BizzGPT = () => {
  const [messages, setMessages] = useState([
    { text: "Hello! I'm BizzAI, a business counseling chatbot. Please provide your name so I can offer personalized advice.", sender: "bot" },
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setMessages([...messages, userMessage, { text: 'Error getting response from chatbot.', sender: 'bot' }]);
    }
     ...
     <div className='padding'>
      <div className="messages">
        {messages.map((message, index) => (
          ...
          >
            {message.sender === 'user' && (
              <img src="./img/user.png" alt="User Avatar" className="avatar" />
            )}
            {message.sender === 'bot' && (
              <img src="./img/robot.png" alt="Bot Avatar" className="avatar" />
            )}
